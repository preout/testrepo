...
[![Build Status](https://travis-ci.org/preout/testrepo.svg?branch=master)](https://travis-ci.org/preout/testrepo)
...
6. If you did everything correct, https://preout.github.io/testrepo/ will lead to your new docs
...
- Documentation(ReDoc): https://preout.github.io/testrepo/
- SwaggerUI: https://preout.github.io/testrepo/swagger-ui/
- Look full spec:
    + JSON https://preout.github.io/testrepo/swagger.json
    + YAML https://preout.github.io/testrepo/swagger.yaml
- Preview spec version for branch `[branch]`: https://preout.github.io/testrepo/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://preout.github.io/testrepo/ with url from the message: `Server started <url>`
